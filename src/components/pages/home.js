...
return (
  ...
  <p style={{ fontSize: '20px' , color:"whitesmoke",  marginBottom: '2%'}}>Web Developer, UX/UI Designer</p>
  <p style={{
	fontSize: "20px",
	width:"50%",
	fontStyle:"italic",
  ...
  <p style={{fontSize: "20px", color:"whitesmoke"}}>Check out my <a href={Skills}>projects</a> to see how I can bring your next project to life.</p>
